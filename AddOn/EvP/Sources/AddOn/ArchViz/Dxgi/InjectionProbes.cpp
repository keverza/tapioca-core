...
bool EnsureCreated (ID3D11DeviceContext* context)
{
    ...
    const char* const entries[4] = { "VSProbeA", "VSProbeB", "PSProbeA", "PSProbeB" };
    const char* const targets[4] = { "vs_5_0", "vs_5_0", "ps_5_0", "ps_5_0" };
    ...
    ok = SUCCEEDED (g_device->CreateDepthStencilState (&depthDesc, &g_depthState)) &&
