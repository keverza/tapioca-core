    ...
    NativeCommandResult ExecuteNative (const GS::ObjectState& params, GS::ProcessControl&) const override
    {
        ...
        os.Add ("occurrenceModelFrames", (GS::Int32) stats.occurrenceModelFrames);
        {
...

            {
                ...
                os.Add ("checkpointCaptures", (GS::Int32) chkStats.capturesIssued);
                os.Add ("checkpointOverflowed", (GS::Int32) chkStats.overflowed);
                os.Add ("checkpointEvaluations", (GS::Int32) chkStats.evaluations);
                ...
                for (uint32_t i = 0; i < count; ++i) {
                    ...
                    entry.Add ("captures", (GS::Int32) row.captures);
                    entry.Add ("frontDraws", (GS::Int32) row.frontDraws);
                    entry.Add ("frontSurvived", (GS::Int32) row.frontSurvived);
                    entry.Add ("behindDraws", (GS::Int32) row.behindDraws);
