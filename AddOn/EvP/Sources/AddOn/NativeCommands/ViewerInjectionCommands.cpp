  ...
  public:
    ...
    NativeCommandResult ExecuteNative (const GS::ObjectState& params, GS::ProcessControl&) const override
    {
        ...
        for (size_t i = 0; i < count; ++i) {
            ...
            row.Add ("projectionSamples", (GS::Int32) group.projectionSamples);
            row.Add ("projectionDivideSamples", (GS::Int32) group.projectionDivideSamples);
